...
module.exports = function (source) {
  ...
  const lastHtmlRspackPluginLoader = htmlWebpackPluginLoaders[htmlWebpackPluginLoaders.length - 1];
  ...
  return 'var _ = eval("require")(' + JSON.stringify(require.resolve('../compiled/lodash/index.js')) + ');' +
